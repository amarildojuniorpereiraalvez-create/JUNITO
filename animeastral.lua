-- animeastral.lua
-- Coloque como ModuleScript em:
-- ReplicatedStorage
-- Nome exato dentro do Studio: animeastral
...
return function(CONFIG)
	...
	local HUB_NAME = CONFIG.HUB_NAME or "JR"
	local FULL_NAME = CONFIG.FULL_NAME or "Junioor"
	local DISCORD_URL = CONFIG.DISCORD_URL or "https://discord.gg/G2gMadWRRx"
	local ICON_IMAGE = CONFIG.ICON_IMAGE or "rbxassetid://72031513619068"
