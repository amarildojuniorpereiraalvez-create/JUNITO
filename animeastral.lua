...
local HUB_NAME = "Anime Astral"
local BRAND_NAME = "JR"
local FULL_BRAND_NAME = "Junioor"
local VERSION = "v0.0.9"
local DISCORD_URL = "https://discord.gg/G2gMadWRRx"

-- IMPORTANTE:
-- Depois que você subir o ícone JR no Roblox, troque o número abaixo pelo ID da imagem.
-- Exemplo: "rbxassetid://123456789012345"
local BRAND_ICON = "rbxassetid://72031513619068"
...
-- ÍCONE PEQUENO NO CANTO, IGUAL AO QUE VOCÊ CIRCULOU
...
-- MARCA DO TOPO, ONDE ANTES APARECIA TWVZ
...
update1.Text = "Version " .. VERSION .. "\n[Main] Branding changed to " .. FULL_BRAND_NAME .. "\n[Main] Discord updated\n[Main] Icon ready for JR asset"
...
discordBtn.Text = "Copy " .. FULL_BRAND_NAME .. " Discord"
...
info.Text = "Brand: " .. FULL_BRAND_NAME .. "\nShort name: " .. BRAND_NAME .. "\nDiscord: " .. DISCORD_URL .. "\nGameId: " .. tostring(game.GameId)
...
print("[Junioor] Anime Astral visual loaded.")
```
